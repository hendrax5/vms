    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                 ...
                 <button className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-sm font-semibold shadow-lg shadow-emerald-500/20 transition-all flex items-center gap-2">
                ...
                {statsConfig.map((stat, i) => (
                    <Link href={stat.href} key={stat.name} className="block group transition-transform hover:-translate-y-1">
                        <motion.div 
                            ...
                            className="bg-slate-900/40 border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] rounded-3xl p-8 backdrop-blur-2xl relative overflow-hidden h-full transition-colors cursor-pointer group-hover:border-white/20"
                        >
